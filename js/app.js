...
alert("Thank you for playing, " + userName + ". You got " + countOfCorrectAnswers + " answers correct, " + countOfIncorrectAnswers + " answers incorrect, and " + countOfUnrecognizedAnswers + " unrecognized answers. Thanks for playing!")